...
- (void)lt_setBackgroundColor:(UIColor *)backgroundColor WithScrollView:(UIScrollView *)scrollView AndValue:(CGFloat)value {
    ...
    CGFloat alpha = MIN(1, 1 - ((value + 64 - offsetY) / 64));
    ...
    if (offsetY > value) {
        self.overlay.backgroundColor = [backgroundColor colorWithAlphaComponent:alpha];
        
    } else {
        self.overlay.backgroundColor = [backgroundColor colorWithAlphaComponent:0];
