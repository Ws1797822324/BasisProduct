...
-(void)settingItem {
    ...
    // 数据
    NSArray *images = @[@"publish-video", @"publish-video", @"publish-video", @"publish-video", @"publish-video", @"publish-video", @"publish-video", @"publish-video", @"publish-video"];
    
    NSArray *titles = @[@"车源", @"商品", @"代卖", @"代收", @"冷库", @"土地", @"农机", @"找工作", @"档口"];
...
- (void)cancelWithCompletionBlock:(void (^)())completionBlock
{
    ...
    for (int i = beginIndex; i<self.view.subviews.count; i++) {
        ...
        anim.beginTime = CACurrentMediaTime() + (i - beginIndex) * 0.03;
