                 ...
                 inputHandler:(MMPopupInputHandler)inputHandler
{
    ...
    if ( self )
    {
        ...
        for ( NSInteger i = 0 ; i < items.count; ++i )
        {
            ...
            [btn setBackgroundImage:item.highlight ? [UIImage mm_imageWithColor:[UIColor greenColor]] : [UIImage mm_imageWithColor:self.backgroundColor] forState:UIControlStateNormal];
